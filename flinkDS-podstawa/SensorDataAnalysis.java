...
public class SensorDataAnalysis {
    public static void main(String[] args) throws Exception {
        ...
        ParameterTool propertiesFromFile = ParameterTool.fromPropertiesFile("SensorDataAnalysis/src/main/resources/flink.properties");
...
//                "26,temperature,1591531561000");
        DataStream<String> inputStream = env.fromSource(Connectors.getFileSource(properties),
